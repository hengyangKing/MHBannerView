...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        self.arrowView.image=[UIImage imageNamed:@"arrows_left_n"];
        self.state = MHBannerFooterStateIdle;
    }
    return self;
}
...
- (void)setState:(MHBannerFooterState)state
{
    _state = state;
    
    switch (state) {
        case MHBannerFooterStateIdle:
        {
            ...
            break;
        case MHBannerFooterStateTrigger:
        {
...
- (UILabel *)label
{
    if (!_label) {
        ...
        _label.textColor = [UIColor colorWithRed:195.0/255.0 green:195.0/255.0 blue:195.0/255.0 alpha:1.0];
...
- (void)setIdleTitle:(NSString *)idleTitle
{
    ...
    if (self.state == MHBannerFooterStateIdle) {
...
- (void)setTriggerTitle:(NSString *)triggerTitle
{
    ...
    if (self.state == MHBannerFooterStateTrigger) {
